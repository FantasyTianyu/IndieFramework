...
namespace AssetBundleBrowser {
    ...
    public class AssetBundleBrowserMain : EditorWindow, IHasCustomMenu, ISerializationCallbackReceiver {
        ...
        [SerializeField]
        internal AssetBundleEditRuleTab m_EditRuleTab;
        ...
        [MenuItem("AssetBundle/AssetBundle Browser", priority = 2050)]
        ...
        private void OnEnable() {
            ...
            if (m_EditRuleTab == null)
                m_EditRuleTab = new AssetBundleEditRuleTab();
            m_EditRuleTab.OnEnable();
            if (m_BuildTab == null)
        ...
        void ModeToggle() {
            ...
            string[] labels = new string[4] { "Configure", "EditRule", "Build", "Inspect" };
